...
# DESCRIPTION
#
#	This script installs the latest version of Microsoft Office BusinessPro Suite.
#
#	File type: pkg
#
# VERSION
...
##########################################################################################
AppName="Microsoft Office"    ## EDIT
DownloadLink="https://go.microsoft.com/fwlink/?linkid=2009112"    ## EDIT
