...
# DESCRIPTION
#
#	This script installs the latest version of A Better Finder Rename 10.
#
#	File type: dmg
#
# VERSION
...
##########################################################################################
AppName="A Better Finder Rename 10"
...
if [ "$arch" == "arm64" ]; then
	...
	DownloadLink="https://www.publicspace.net/download/ABFRX10.dmg"
...
function CopyApp () 
{
    ...
    yes | hdiutil attach -nobrowse "$dmgFilePath" > /dev/null
