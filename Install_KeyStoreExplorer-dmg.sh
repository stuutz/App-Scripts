...
# DESCRIPTION
#
#	This script installs the latest version of KeyStore Explorer.
#
#	File type: dmg
#
# VERSION
...
latestVersion=$(/usr/bin/curl -sL 'https://github.com/kaikramer/keystore-explorer/releases' | grep "KSE Release" | sed -n 1p | awk '{print $5}' | sed 's/\///g ; s/href=kaikramerkeystore-explorerreleasestagv//g' | tr -d '"href=kaikramerkeystore-explorerreleasestagv-')
latestVersion2=$(/usr/bin/curl -sL 'https://github.com/kaikramer/keystore-explorer/releases' | grep "KSE Release" | sed -n 1p | awk '{print $5}' | sed 's/\///g ; s/href=kaikramerkeystore-explorerreleasestagv//g' | tr -d '"href=kaikramerkeystore-explorerreleasestagv-.')
...
if [ "$arch" == "arm64" ]; then
	...
	DownloadLink="https://github.com/kaikramer/keystore-explorer/releases/download/v${latestVersion}/kse-${latestVersion2}.dmg"
