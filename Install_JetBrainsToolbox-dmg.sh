...
# DESCRIPTION
#
#	This script installs the latest version of JetBrains Toolbox.
#
#	File type: dmg
#
# VERSION
...
##########################################################################################
AppName="JetBrains Toolbox"    ## EDIT
processName="jetbrains-toolbox"    ## EDIT
dmgApp="/Volumes/JetBrains Toolbox/JetBrains Toolbox.app"    ## EDIT
dmgMountName="/Volumes/JetBrains Toolbox"    ## EDIT
...
if [ "$arch" == "arm64" ]; then
	...
	DownloadLink="https://download.jetbrains.com/toolbox/jetbrains-toolbox-$4-arm64.dmg"    ## EDIT
          
elif [ "$arch" == "i386" ]; then
    
    echo "Intel Found"
    
    DownloadLink="https://download.jetbrains.com/toolbox/jetbrains-toolbox-$4.dmg"	## EDIT
