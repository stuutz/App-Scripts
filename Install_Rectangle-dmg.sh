...
AppName="Rectangle"
latestVer=$4
dmgApp="/Volumes/$AppName${latestVer}/$AppName.app"
dmgMountName="/Volumes/$AppName${latestVer}"
...
if [ "$arch" == "arm64" ]; then
	...
	DownloadLink="https://github.com/rxhanson/Rectangle/releases/download/v${latestVer}/Rectangle${latestVer}.dmg"
