...
# DESCRIPTION
#
#	This script installs the latest version of Sublime Merge.
#
#	File type: zip
#
# VERSION
...
##########################################################################################
AppName="Sublime Merge"    ## EDIT
processName="sublime_merge"
latestVersion=$(/usr/bin/curl -sL 'https://www.sublimemerge.com/download' | grep "Build" | sed -n 1p | awk '{print $4}' | tr -d '</p>')    ## EDIT
DownloadLink="https://download.sublimetext.com/sublime_merge_build_${latestVersion}_mac.zip"    ## EDIT
