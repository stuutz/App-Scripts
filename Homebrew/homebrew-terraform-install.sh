...
# CHANGE HISTORY
#
# 	- Created script (1.0) - 2/22/2021
#	- Fixed installation error, added verbose option for more detailed script results (1.1) - 2/23/2021
#	- Updated the logged in user variable (1.2) - 1/11/2022
#
####################################################################################################
...
appName="Terraform"
appFormula="brew install terraform"
