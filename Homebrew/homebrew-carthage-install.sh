...
# CHANGE HISTORY
#
# 	- Created script - 2/22/2021 (1.0)
#	- Fixed installation error, added verbose option for more detailed script results - 2/23/2021 (1.1)
...
appName="Carthage"
appFormula="brew install carthage"
