...
# DESCRIPTION
#
#	This script installs the latest version of DBeaver.
#
#	File type: dmg
#
# VERSION
...
##########################################################################################
AppName="DBeaver"    ## EDIT
processName="dbeaver"    ## EDIT
dmgApp="/Volumes/$AppName Community/$AppName.app"    ## EDIT
dmgMountName="/Volumes/$AppName Community"    ## DON'T EDIT
...
if [ "$arch" == "arm64" ]; then
	...
	DownloadLink="https://dbeaver.io/files/dbeaver-ce-latest-macos-aarch64.dmg"    ## EDIT
          
elif [ "$arch" == "i386" ]; then
    
    echo "Intel Found"
    
    DownloadLink="https://dbeaver.io/files/dbeaver-ce-latest-macos-x86_64.dmg"	## EDIT
