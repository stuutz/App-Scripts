...
# DESCRIPTION
#
#	This script installs the latest version of Android Studio.
#
#	File type: dmg
#
# VERSION
...
processName="studio"
dmgApp="/Volumes/$AppName - $codename | ${shortVersion} Patch ${patch}/$AppName.app"
dmgMountName="/Volumes/$AppName - $codename | ${shortVersion} Patch ${patch}"
...
if [ "$arch" == "arm64" ]; then
	...
	DownloadLink="https://redirector.gvt1.com/edgedl/android/studio/install/${fullVersion}/android-studio-${fullVersion}-mac_arm.dmg"
          
elif [ "$arch" == "i386" ]; then
    
    echo "Intel Found"
    
    DownloadLink="https://redirector.gvt1.com/edgedl/android/studio/install/${fullVersion}/android-studio-${fullVersion}-mac.dmg"
