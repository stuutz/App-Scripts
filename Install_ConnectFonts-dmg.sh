...
# DESCRIPTION
#
#	This script installs the latest version of Connect Fonts.
#
#	File type: dmg
#
# VERSION
...
if [ "$arch" == "arm64" ]; then
	...
	DownloadLink="https://links.extensis.com/suitcase/sf_latest?language=en&platform=mac"
