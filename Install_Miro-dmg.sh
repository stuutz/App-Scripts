...
# DESCRIPTION
#
#	This script installs the latest version of Miro.
#
#	File type: dmg
#
# VERSION
...
if [ "$arch" == "arm64" ]; then
	...
	DownloadLink="https://desktop.miro.com/platforms/darwin-arm64/$AppName.dmg"    ## EDIT
          
elif [ "$arch" == "i386" ]; then
    
    echo "Intel Found"
    
    DownloadLink="https://desktop.miro.com/platforms/darwin/$AppName.dmg"	## EDIT
