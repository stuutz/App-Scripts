...
# DESCRIPTION
#
#	This script installs the latest version of Sourcetree.
#
#	File type: zip
#
# VERSION
...
##########################################################################################
AppName="Sourcetree"    ## EDIT
DownloadLink="https://product-downloads.atlassian.com/software/sourcetree/ga/Sourcetree_$4.zip"    ## EDIT
