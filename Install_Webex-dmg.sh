...
# DESCRIPTION
#
#	This script installs the latest version of Webex.
#
#	File type: dmg
#
# VERSION
...
if [ "$arch" == "arm64" ]; then
	...
	DownloadLink="https://binaries.webex.com/WebexDesktop-MACOS-Apple-Silicon-Gold/$AppName.dmg"    ## EDIT
          
elif [ "$arch" == "i386" ]; then
    
    echo "Intel Found"
    
    DownloadLink="https://binaries.webex.com/WebexTeamsDesktop-MACOS-Gold/$AppName.dmg"	## EDIT
