...
# DESCRIPTION
#
#	This script installs the latest version of Node.js LTS (long term support).
#
#	File type: pkg
#
# VERSION
...
##########################################################################################
AppName="node-js-LTS"    ## EDIT
latestVersion=$(/usr/bin/curl -sL 'https://nodejs.org/en/' | grep "LTS" | sed -n 2p | awk '{print $1}')    ## EDIT
