...
# DESCRIPTION
#
#	This script installs the latest version of EasyFind.
#
#	File type: zip
#
# VERSION
...
##########################################################################################
AppName="EasyFind"    ## EDIT
latestVersion=$(/usr/bin/curl -sL 'https://www.devontechnologies.com/apps/freeware' | grep "EasyFind.app.zip" | awk '{print $6}' | sed 's/.$//')    ## EDIT
DownloadLink="https://download.devontechnologies.com/download/freeware/easyfind/${latestVersion}/EasyFind.app.zip"    ## EDIT
