...
# DESCRIPTION
#
#	This script installs the latest version of Topaz DeNoise AI.
#
#	File type: dmg
#
# VERSION
...
##########################################################################################
AppName="Topaz DeNoise AI"
latestVersion=$(/usr/bin/curl -sL 'https://community.topazlabs.com/c/releases/denoise-ai/63.rss' | grep "dmg" | awk '{print $2}' | sed -n 1p | tr -d '()v:')
...
if [ "$arch" == "arm64" ]; then
	...
	DownloadLink="https://downloads.topazlabs.com/deploy/TopazDeNoiseAI/latest/TopazDeNoiseAI-Full-Installer.dmg"
...
function CleanUp () 
{
    ...
    diskutil eject /Volumes/Topaz\ DeNoise\ AI\ $latestVersion
