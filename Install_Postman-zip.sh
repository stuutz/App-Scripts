...
# DESCRIPTION
#
#	This script installs the latest version of Postman.
#
#	File type: zip
#
# VERSION
...
if [ "$arch" == "arm64" ]; then
	...
	DownloadLink="https://dl.pstmn.io/download/latest/osx_arm64"    ## EDIT
          
elif [ "$arch" == "i386" ]; then
    
    echo "Intel Found"
    
    DownloadLink="https://dl.pstmn.io/download/latest/osx"	## EDIT
